/**
 *
 * Credit: https://github.com/kangax/protolicious/raw/master/event.simulate.js
 *
...
RecordSelect.Single.prototype = Object.extend(new RecordSelect.Abstract(), {
  onload: function() {
    ...
    this.hidden_input.writeAttribute(this.options.hidden_html_options);
  ...
  onselect: function(id, value) {
    ...
    this.set(id, value);
    this.close();
    this.hidden_input.simulate('change');
  },
